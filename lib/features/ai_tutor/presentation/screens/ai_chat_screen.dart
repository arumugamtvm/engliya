...
class _AIChatScreenState extends State<AIChatScreen>
  ...
  Future<void> _sendMessage([String? text]) async {
    ...
    try {
      ...
      final response = widget.lessonContext != null
          ? await _aiService.answerQuestion(
              question: msg,
                    ...
                    child: Row(
                      ...
                      children: [
                        _actionBtn(
                          ...
                          speaking ? Colors.orange : Colors.grey,
                          () => _speak(msg.text, msg.id),
                        ),
                        const SizedBox(width: 8),
                        _actionBtn(Icons.copy, Colors.grey, () {
  ...
  Widget _formatText(String text, bool isUser, bool isError) {
    final baseColor = isUser
        ? Colors.white
        : (isError ? Colors.red.shade700 : Colors.black87);
