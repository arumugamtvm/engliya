...
void main() {
  group('Phase 5 Final Test Property Tests', () {
    ...
    property('Property 9: Question model validity - MCQ types have options/correctIndex, speaking tasks do not', () {
      forAll(
        combine4(
          integer(min: 0, max: 4),
        ...
        (values) {
          ...
          switch (typeIndex) {
            case 0:
              ...
              question = Phase5FinalTestQuestion.businessEnglish(
                id: 'test_business_1', unitId: 'phase5_unit22', lessonId: 'phase5_lesson22_1',
                prompt: prompt, options: options, correctIndex: validCorrectIndex,
              );
              break;
            case 1:
              expectedType = Phase5QuestionType.interview;
              question = Phase5FinalTestQuestion.interview(
                id: 'test_interview_1', unitId: 'phase5_unit23', lessonId: 'phase5_lesson23_1',
                prompt: prompt, options: options, correctIndex: validCorrectIndex,
              );
              break;
            case 2:
              ...
              question = Phase5FinalTestQuestion.presentation(
                id: 'test_presentation_1', unitId: 'phase5_unit24', lessonId: 'phase5_lesson24_1',
                prompt: prompt, options: options, correctIndex: validCorrectIndex,
              );
              break;
            case 3:
              ...
              question = Phase5FinalTestQuestion.writing(
                id: 'test_writing_1', unitId: 'phase5_unit25', lessonId: 'phase5_lesson25_1',
                prompt: prompt, options: options, correctIndex: validCorrectIndex,
              );
              break;
            default:
              expectedType = Phase5QuestionType.speaking;
              question = Phase5FinalTestQuestion.speaking(
                id: 'test_speaking_1', unitId: 'phase5_unit25', lessonId: 'phase5_lesson25_1',
                prompt: prompt,
              );
          }
          ...
          if (question.type == Phase5QuestionType.speaking) {
    ...
    property('Property 6: Pass/fail threshold - passed is true iff totalScore >= 45', () {
      forAll(
        combine2(
          integer(min: 0, max: 27),
        ...
        (values) {
          ...
          final expectedPassed = totalScore >= 45;
    ...
    property('Property 10: Total score calculation - totalScore = mcqCorrect + speakingScore', () {
      forAll(
        combine2(
          integer(min: 0, max: 27),
          integer(min: 0, max: 32),
    ...
    property('Property 5: Speaking score tiers - word count maps to correct score', () {
      forAll(
    ...
    property('Property 3: Question distribution consistency - exact counts for each type', () {
      forAll(
        ...
        (testCount) {
          ...
          final totalFromDistribution = expectedBusinessCount + 
          ...
          final mcqCount = expectedBusinessCount + 
              expectedInterviewCount + 
              expectedPresentationCount + 
              expectedWritingCount;
          expect(mcqCount, 27);
    ...
    property('Property 11: Fallback question guarantee - always returns 35 questions', () {
      forAll(
        combine4(
        ...
        (availableCounts) {
          ...
          final fallbackBusinessNeeded = (requiredBusiness - availableBusiness).clamp(0, requiredBusiness);
          final fallbackInterviewNeeded = (requiredInterview - availableInterview).clamp(0, requiredInterview);
          final fallbackPresentationNeeded = (requiredPresentation - availablePresentation).clamp(0, requiredPresentation);
          final fallbackWritingNeeded = (requiredWriting - availableWriting).clamp(0, requiredWriting);
          
          final totalBusiness = (availableBusiness.clamp(0, requiredBusiness)) + fallbackBusinessNeeded;
          final totalInterview = (availableInterview.clamp(0, requiredInterview)) + fallbackInterviewNeeded;
          final totalPresentation = (availablePresentation.clamp(0, requiredPresentation)) + fallbackPresentationNeeded;
          final totalWriting = (availableWriting.clamp(0, requiredWriting)) + fallbackWritingNeeded;
          ...
          final total = totalBusiness + totalInterview + totalPresentation + totalWriting + requiredSpeaking;
          expect(total, 35);
        },
      );
    });
